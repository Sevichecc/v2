...
// WithoutFutureEntries returns a new EntryQueryBuilder without future entries.
func (e *EntryQueryBuilder) WithoutFutureEntries(filterFutureEntries bool) *EntryQueryBuilder {
	if filterFutureEntries {
